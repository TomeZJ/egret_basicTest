...
var basicTest = (function (_super) {
    __extends(basicTest, _super);
    function basicTest() {
        var _this = _super.call(this) || this;
        _this.once(egret.Event.ADDED_TO_STAGE, _this.onAddToStage, _this);
        return _this;
    }
    basicTest.prototype.onAddToStage = function (event) {
        var imgLoader = new egret.ImageLoader;
        imgLoader.once(egret.Event.COMPLETE, this.imgLoadHandler, this);
        imgLoader.load("resource/assets/egret_icon.png");
    };
    basicTest.prototype.imgLoadHandler = function (evt) {
        //获取加载到的纹理对象
    ...
    /// 旋转及缩放步长设定
    basicTest.STEP_ROT = 3;
    basicTest.STEP_SCALE = .03;
    return basicTest;
}(egret.DisplayObjectContainer));
__reflect(basicTest.prototype, "basicTest");
